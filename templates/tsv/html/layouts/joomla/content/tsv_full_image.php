...
?>
<div class="xxxxxxx_my-gallery">
<figure class="xxxxxxxxxx_tsv_gallery <?php echo htmlspecialchars($imgclass, ENT_COMPAT, 'UTF-8'); ?> item-image">
	<img class="img-fluid img-thumbnail" src="<?php echo htmlspecialchars($img->url, ENT_COMPAT, 'UTF-8'); ?>"
			 <?php echo $alt; ?>
			 itemprop="image"
			<?php //echo $extraAttr; ?>
	/>
	<?php if ($images->image_fulltext_caption !== '') : ?>
		<figcaption class="figure-caption text-center"><?php echo htmlspecialchars($images->image_fulltext_caption, ENT_COMPAT, 'UTF-8'); ?></figcaption>
	<?php endif; ?>
</figure>
</div>
